...
export interface WhatsAppButtonProps {
   ...
   * Se não fornecido, usa o número padrão da Beergam
   */
  phoneNumber?: string;
  /**
   * Mensagem pré-definida para enviar
   */
  message?: string;
}

/**
 * Componente de botão flutuante para abrir conversa no WhatsApp
...
export function WhatsAppButton({
  ...
  return (
    <FloatingButton
      size={size}
      onClick={handleClick}
      className="bg-[#25D366] text-white hover:bg-[#20BA5A] focus:ring-[#25D366]"
