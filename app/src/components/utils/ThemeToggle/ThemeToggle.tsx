...
export function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 rounded-full bg-beergam-blue text-white shadow-lg hover:bg-beergam-blue-dark hover:scale-110 active:scale-95 transition-all duration-300 group"
      aria-label={
