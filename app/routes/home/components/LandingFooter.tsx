    ...
    <footer className="bg-beergam-blue-lara border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <h4 className="text-beergam-white font-semibold mb-4">Social</h4>
            <ul className="space-y-2">
              <li>
                <Link
                  to="https://wa.me/5511936194419?text=Olá! Gostaria de saber mais sobre o Beergam."
                  target="_blank"
                  className="flex items-center gap-2 text-beergam-gray-light hover:text-beergam-orange transition-colors text-sm"
                >
              ...
              <li>
                <Link
                  to="https://www.instagram.com/beergamerp"
                  target="_blank"
                  className="flex items-center gap-2 text-beergam-gray-light hover:text-beergam-orange transition-colors text-sm"
                >
                  <span className="inline-block w-5 h-5 align-middle">
