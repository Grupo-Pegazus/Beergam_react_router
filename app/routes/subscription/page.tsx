              ...
              `}
                >
                  ...
                  {plan.is_current_plan && (
                    <button className="w-full py-3 px-6 rounded-2xl font-medium text-beergam-blue-primary bg-beergam-blue-light hover:bg-beergam-blue-light transition-colors flex items-center justify-center gap-2">
                      <p className="text-beergam-blue-primary text-sm">
                        Plano atual
                      </p>
                    </button>
                  )}
