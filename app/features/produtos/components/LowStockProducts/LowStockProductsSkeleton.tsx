        ...
        <MainCards key={index} className="flex h-full flex-col gap-3 p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0 flex-1 space-y-2">
              <div className="h-4 bg-beergam-mui-paper rounded animate-pulse" />
              <div className="h-3 bg-beergam-mui-paper rounded w-2/3 animate-pulse" />
            </div>
          </div>
          <div className="space-y-2">
            <div className="h-2 bg-beergam-mui-paper rounded animate-pulse" />
