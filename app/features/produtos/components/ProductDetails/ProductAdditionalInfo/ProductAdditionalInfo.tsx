...
export default function ProductAdditionalInfo({
  ...
  return (
    <CensorshipWrapper censorshipKey="produtos_list_details_financial">
      <Paper
        elevation={0}
        sx={{
          p: 3,
                  ...
                  <Stack spacing={1.5}>
                    ...
                    {product.ean && (
                      <Box>
                        ...
                        <TextCensored
                          maxCharacters={3}
                          censorshipKey="produtos_list_details_financial"
                        >
                          <Typography
                            variant="body2"
                            sx={{ fontWeight: 600, fontFamily: "monospace" }}
                      ...
                      <Box>
                        ...
                        >
                          <Chip
                            ...
                            size="small"
                            sx={{
                              bgcolor: product.tax_replacement
                                ? "#d1fae5"
                                : "#fee2e2",
                              color: product.tax_replacement
                                ? "#065f46"
                                : "#991b1b",
                              fontWeight: 600,
                              height: 24,
                  ...
                  <Stack spacing={1.5}>
                    {product.extra_cost && (
                      <Box>
                        ...
                        >
                          <Typography variant="body2" sx={{ fontWeight: 600 }}>
                            {parseFloat(product.extra_cost).toLocaleString(
                              "pt-BR",
                              {
                                style: "currency",
                                currency: "BRL",
                    ...
                    {product.packaging_cost && (
                      <Box>
                        ...
                        >
                          <Typography variant="body2" sx={{ fontWeight: 600 }}>
                            {parseFloat(product.packaging_cost).toLocaleString(
                              "pt-BR",
                              {
                                style: "currency",
                                currency: "BRL",
