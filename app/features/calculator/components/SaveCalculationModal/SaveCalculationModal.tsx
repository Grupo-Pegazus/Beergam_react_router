...
import { useSaveCalculation } from "../../hooks";
import type { CalculatorRequest, CalculatorResponse } from "../../typings";
...
interface SaveCalculationModalProps {
  ...
  outputPayload: CalculatorResponse;
}
